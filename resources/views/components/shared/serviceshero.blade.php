...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-6">
    <!-- Card -->
    <a class="group flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl hover:shadow-md focus:outline-hidden focus:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="{{ route('domain.create') }}">
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center gap-x-3">
          <div class="grow">
            <h3 class="group-hover:text-violet-600 font-semibold text-gray-800 dark:group-hover:text-neutral-400 dark:text-neutral-200">
              Domain Registration & Management
            </h3>
            <p class="text-sm text-gray-500 dark:text-neutral-500">
              We register, host and manage domain names with atomated provisioning except for .pg domains. We manually provision .pg domains.
            </p>
          </div>
          <div>
      ...
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center gap-x-3">
          <div class="grow">
            ...
            <p class="text-sm text-gray-500 dark:text-neutral-500">
              We offer flexible hosting plans to suit your business needs, starting with basic Wantok plan to more advanced Kundu and Kumul hosting plans.
               We also empower web developers by providing free hosting.
            </p>
          </div>
          <div>
            <svg class="shrink-0 size-5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
      ...
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center gap-x-3">
          <div class="grow">
            ...
            <p class="text-sm text-gray-500 dark:text-neutral-500">
              We provide WordPress hosting with automated installation and management of WordPress sites.
            </p>
          </div>
          <div>
            <svg class="shrink-0 size-5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
      ...
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center gap-x-3">
          <div class="grow">
            ...
            <p class="text-sm text-gray-500 dark:text-neutral-500">
              Build your professional website using easy to use editor and publish your web pages right from your control panel. Choose from 500+ Responsive website templates and themes to help you build your website for free.
            </p>
          </div>
          <div>
            <svg class="shrink-0 size-5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
      ...
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center gap-x-3">
          <div class="grow">
            ...
            <p class="text-sm text-gray-500 dark:text-neutral-500">
             We provide a user-friendly control panel to manage your hosting services, domains, and web applications with ease. Note that we provide control panel access to all our subscribed clients for free.       </div>
          <div>
            <svg class="shrink-0 size-5 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
          </div>
        </div>
